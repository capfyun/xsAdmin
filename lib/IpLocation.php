...
class IpLocation{
	 ...
	 */
	public function __construct($filename = __DIR__."/ip_location/qqwry.dat"){
		$this->fp = 0;
	...
	/**
	 * 解析
	 * @param string $ip ip或域名
	 * @return null|array array('ip'=>'','beginip'=>'','endip'=>'','country'=>'','area'=>'')
	 */
	public function parsing($ip){
		...
		// CZNET表示没有有效信息
		$location['country']==" CZNET" && $location['country'] = "未知";
		$location['area']==" CZNET" && $location['area'] = "";
		return $location;
	}
